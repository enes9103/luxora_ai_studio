...
export const ImageUploader: React.FC<ImageUploaderProps> = ({ onImageUpload, uploadedImage }) => {
  ...
  return (
    <div className="space-y-4">
        <div 
          className="relative w-full aspect-square bg-muted/60 rounded-2xl flex items-center justify-center border-2 border-dashed border-border/70 hover:border-primary transition-all group overflow-hidden shadow-[0_14px_45px_-30px_rgba(0,0,0,0.6)]"
