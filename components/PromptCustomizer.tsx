...
const Card: React.FC<{children: React.ReactNode, className?: string}> = ({children, className}) => (
    <div className={`relative overflow-hidden bg-card/90 border border-border/70 rounded-2xl shadow-[0_20px_60px_-35px_rgba(0,0,0,0.65)] backdrop-blur ${className}`}>
        <div className="absolute inset-0 pointer-events-none bg-gradient-to-br from-primary/5 via-transparent to-transparent"></div>
        <div className="relative">{children}</div>
    </div>
);

const CardHeader: React.FC<{title: string, description: string}> = ({title, description}) => (
    <div className="p-4 sm:p-5 border-b border-border/60 bg-gradient-to-r from-primary/8 to-transparent">
...
const CardFooter: React.FC<{children: React.ReactNode, className?: string}> = ({children, className}) => (
    <div className={`p-4 sm:p-5 border-t border-border/60 bg-card/70 ${className}`}>{children}</div>
);
