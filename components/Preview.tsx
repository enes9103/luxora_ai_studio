...
const PromptDetailsDisplay: React.FC<{ 
    ...
    return (
        <div className="rounded-2xl border border-border/70 bg-card/90 animate-fade-in shadow-[0_20px_60px_-35px_rgba(0,0,0,0.65)]">
            ...
            {details.negative_prompt && (
                ...
                <div className="p-4 sm:p-6 border-t border-border/60 space-y-4">
                    {details.negative_prompt.exclude_visuals.length > 0 && (
                        <div>
...
export const Preview: React.FC<PreviewProps> = ({ editedImages, isLoading, prompt, onRetryWithSamePrompt, ...driveProps }) => {
  ...
  return (
    <div className="space-y-6">
        <div className="rounded-2xl border border-border/70 bg-card/90 p-4 shadow-[0_20px_60px_-35px_rgba(0,0,0,0.65)]">
            <h3 className="text-lg font-semibold text-center mb-4 text-card-foreground">{getCardTitle()}</h3>
            <div className="relative aspect-square bg-muted/60 rounded-xl flex items-center justify-center overflow-hidden">
